...
export default function AboutJobMonitor() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Lightning-fast job execution monitoring with minimal latency. Real-time updates ensure you never miss critical events.",
    },
    {
      icon: Shield,
      ...
      description:
        "Enterprise-grade security with encryption and role-based access control. Reliable monitoring with 99.8% uptime guarantee.",
    },
  ];
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 py-8 border-t border-b">
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Monitor jobs as they execute with live status updates.
            </p>
          </div>

          <div className="text-center">
            <div className="text-4xl font-bold text-green-600 mb-2">🔒</div>
            <p className="font-semibold">Secure Monitoring</p>
            <p className="text-sm text-muted-foreground mt-1">
              Built with authentication and protected access in mind.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Analyze logs, metrics, and job performance from one dashboard.
            </p>
          </div>
        </section>
      </div>
