  ...
  return (
    <div className="space-y-6 p-4">
      ...
      <div className="space-y-3">
              ...
              <FormControl>
                ...
                >
                  <TabsList className="bg-gray-200 p-1">
                    <TabsTrigger
                      value="enabled"
                      className="px-10 py-2 text-sm font-semibold data-[state=active]:bg-white data-[state=active]:text-green-600"
                    >
                      Enabled
                    </TabsTrigger>
                    ...
                    <TabsTrigger
                      value="disabled"
                      className="px-10 py-2 text-sm font-semibold data-[state=active]:bg-white data-[state=active]:text-orange-600"
                    >
                      Disabled
                    </TabsTrigger>
                  </TabsList>
        ...
        <FormField
          control={form.control}
          name="logWindowsEvent"
          render={({ field }) => (
            <FormItem className="flex items-center justify-between rounded-lg border bg-muted/40 p-4">
              <div className="space-y-1">
                <FormLabel className="cursor-pointer text-base font-semibold">
                  Windows Event Logging
                </FormLabel>
                <p className="text-xs text-muted-foreground">
                  Record application errors in the Windows Event Viewer to
                  assist with monitoring and debugging.
                </p>
              </div>
