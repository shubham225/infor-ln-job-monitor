...
// Call `useToast()` inside components to read the current toast list
// (used by <Toaster /> to render them).
...
// Convenience helpers: toast.info(...), toast.warning(...), toast.error(...), toast.success(...)
